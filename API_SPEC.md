...
- 醫療急症、火災、天然災害、受困救援、山域/水域救援、失溫、中暑、高山症、溪水暴漲：通常建議 119
- 自殺危機：同步建議 119 與 110
- 失蹤走失、暴力、犯罪、持刀、跟蹤、闖入、人身威脅：通常建議 110
...
山域/偏鄉情境通常會把「疑似山域水域救援」保留在 `symptom_summary` 或 `description`，並在 `dispatch_advice` 裡提示使用者提供 GPS 座標、步道/地標、同行人數、傷勢、可否移動、手機電量與天候。電梯等受困救援偏向 119；自殺危機會同步提醒 119 與 110；一般失蹤走失偏向 110，若在山區、水域或偏鄉則同步 119。暴力或犯罪情境則會在 `dispatch_advice` 中偏向警察，若有人受傷則同步提醒救護。
