...
def heuristic_semantic_understanding(
    ...
    danger_keywords = [
        ...
        "燙傷", "燒傷", "灼傷", "燙到", "燒到", "水泡",
        "火災", "失火", "著火", "起火",
        "地震", "強震", "颱風", "豪雨", "淹水", "土石流", "坍方", "倒塌", "受困", "被壓住", "有人被埋",
        "電梯受困", "困在電梯", "自殺", "想死", "輕生", "跳樓", "失蹤", "走失",
        "OHCA", "到院前心肺功能停止", "心肺功能停止", "心跳停止", "中風", "腦中風", "心肌梗塞",
...
_SLOT_RELEVANT_BY_CATEGORY: Dict[str, List[str]] = {
    ...
    "受困救援": ["danger_active", "people_injured"],
    "自殺危機": ["danger_active", "people_injured"],
    "失蹤走失": ["danger_active", "people_injured"],
