...
def simple_extract(text: str) -> Extracted:
    ...
    if has_child_protection_signal or has_explicit_violence_signal or has_weapon_threat_context or (
        ...
        ex.category = "暴力事件"
    elif v4_category in ["交通事故", "可疑人士", "火災", "天然災害", "暴力事件"]:
    ...
    injury_terms = ["流血", "大量流血", "血流不停", "受傷", "燙傷", "燒傷", "灼傷", "燙到", "燒到", "水泡", "昏倒", "暈倒", "暈過去", "昏過去", "倒地", "倒下", "倒在地上", "倒在路邊", "沒反應", "沒有反應", "無反應", "叫不醒", "沒呼吸", "抽搐", "骨折", "頭暈", "胸痛", "胸悶", "心臟痛", "半邊無力", "嘴歪", "講話不清楚", "呼吸困難", "喘不過氣", "吸不到氣", "嘔吐", "噎到", "哽塞", "噎住", "臉發紫", "中暑", "熱衰竭", "癲癇", "失溫", "高山症", "脫水", "蛇咬", "蜂螫", "墜落", "摔落", "滑落", "墜谷", "被水沖走", "被沖走", "沖走", "被壓住", "有人被埋", "瓦礫壓住", "困在裡面", "出不來", "不能走", "無法走", "無法行走", "走不動", "AED", "CPR", "胸外按壓", "救護車", "沒有在呼吸", "沒在呼吸"]
    ...
    ex.danger_active = True if has_child_protection_signal or any(k in text for k in ["還在", "持續", "正在", "還沒結束", "還在現場", "追人", "追我", "揮刀", "攻擊", "毆打", "攻擊中", "迷路", "迷途", "受困", "失聯", "溪水暴漲", "溪水變大", "溪水變急", "水位上升", "被水沖走", "被沖走", "沖走", "卡在對岸", "過不了溪", "過不了河", "漂走", "水變深", "渡溪失敗", "坍方", "落石", "土石流", "地震", "強震", "還在搖", "餘震", "淹水", "積水", "建築物倒塌", "房屋倒塌", "大樓倒塌", "橋斷", "道路中斷", "被壓住", "有人被埋", "瓦礫壓住", "停電", "手機快沒電", "手機沒電", "快沒電", "電量不足", "剩一格電", "只剩一格電", "剩5%", "剩 5%", "剩不到10%", "剩不到 10%", "沒訊號", "沒有訊號", "訊號不好", "定位跑掉", "GPS不準", "GPS 不準", "找不到座標", "不知道座標", "沒有座標", "下大雨", "大雨", "起霧", "濃霧", "氣溫很低", "低溫", "很冷", "天黑", "天色變暗", "不能走", "無法走", "無法行走", "走不動"]) else None
