...
def taxonomy_prompt_summary() -> str:
    return """台灣事件分類與建議單位：
- 刑事案件：暴力、竊盜、毒品、家暴、性侵、特殊刑案、失蹤人口/走失優先 110；詐欺/網路詐騙提醒 165，若有人身危險再 110；家暴、兒少、性侵可提醒 113。
- 災害救護事件：火災、天然災害、受困救援、緊急救護、自殺危機、交通事故、山域/水域救援、危險物品事故優先 119；自殺危機同步 110，交通事故若需交通管制也可能需要 110。
